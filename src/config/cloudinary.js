...
// Instead, we'll use the Upload Widget
...
// Note: Signature generation should ideally be done on the server side
...
// Export the folder constants for use in other components
export { FOLDERS }; 