      ...
      try {
        ...
        try {
          ...
          if (!accessResponse.data.canAccess) {
            // Form is not currently accessible
          ...
          // If we get here, the form is accessible
          setError(null);
        ...
        // Get form details from the public status endpoint for display purposes
