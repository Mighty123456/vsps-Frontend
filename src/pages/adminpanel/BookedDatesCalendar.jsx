  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="relative">
        ...
        {hoveredEvent && (
          <div
            className="absolute bg-white rounded-lg shadow-lg p-4 z-50 border border-gray-200"
            style={{
          ...
          >
            <div className="space-y-2">
              <h4 className="font-semibold text-gray-900">{hoveredEvent.customerName}</h4>
              <div className="text-sm text-gray-600">
                <p><span className="font-medium">Event Type:</span> {hoveredEvent.eventType}</p>
                <p><span className="font-medium">Guests:</span> {hoveredEvent.guestCount}</p>
                <p><span className="font-medium">Time:</span> {hoveredEvent.startTime} - {hoveredEvent.endTime}</p>
                <p>
                  <span className="font-medium">Status:</span>{' '}
                  <span className={`px-2 py-1 rounded-full text-xs ${
                    hoveredEvent.status === 'Booked' ? 'bg-red-100 text-red-800' :
                    hoveredEvent.status === 'Approved' ? 'bg-blue-100 text-blue-800' :
